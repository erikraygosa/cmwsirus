...
@section('content_header')
    <h1>Accidente Nuevo</h1>
@stop

@section('content')
    <p>Capturar Accidentes</p>

    <form id="form-accidente" method="POST" action="{{route('accidentes.store')}}">
    @csrf
      ...
      <div class="col mb-3">
        <div class="btn-group btn-group-toggle mb-3" data-toggle="buttons">
          <label class="btn btn-outline-secondary">
            <input type="radio" name="hh_accidente" id="hh_AccidenteInterno" autocomplete="off" value="I"> Interno
          </label>
          <label class="btn btn-outline-secondary">
            <input type="radio" name="hh_accidente" id="hh_AccidenteExterno" autocomplete="off" value="E"> Externo
          </label>
...
<div class="tab-content">
  ...
  <div class="form-group row">
    <div class="col-sm-2">
      ...
      <input type="date" class="form-control" id="dg_fecha" name="dg_fecha">
    </div>
    <div class="col-sm-2">
      <label for="dg_hora" class="col-form-label">Hora</label>
      <input type="time" class="form-control" id="dg_hora" name="dg_hora">
    </div>
    <div class="col-sm-8">
      <label for="dg_lugarAccidente" class="col-form-label">Lugar del accidente</label>
      <input type="text" class="form-control" id="dg_lugarAccidente" name="dg_lugarAccidente">
    </div>
  </div>
  <div class="form-group row">
  <div class="col-sm-4">
  ...
  <div class="form-group row">
    <div class="col-sm-12">
      ...
      <textarea class="form-control form-control-lg" rows="5" name="dg_descripcionAccidente" id="dg_descripcionAccidente"></textarea>
    </div>
  </div>
...
<div class="col-sm-3">
  ...
  <div class="col-sm-6">
    ...
    <select class="form-control" name="du_ruta" id="select-ruta">
        <option value="">Selecciona una opción</option>
...
<div class="form-group row">
  ...
  <div class="col-sm-3">
    <label for="fecha" class="col-sm-2 col-form-label ">Licencia</label>
    <input type="text" class="form-control " id="fecha" name="du_licencia">
  </div>
 
  <div class="col-sm-4">
    <label class="col-sm-6 col-form-label">Zona de Accidente</label>
    <select class="form-control" name="Zona" id="select-zona" disabled>
...
<div class="container">
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <textarea class="form-control" id="ot_lesionadosExtra"  disabled name="ot_lesionadosExtra" rows="12"></textarea>
    </div>
  </div>
  <div class="col-md-6">
    <div class="form-group">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" disabled name="ot_ajustador" id="ot_ajustador">
          </div>
          <div class="form-group">
            <label for="cqInput">Número (CQ)</label>
            <input type="text" class="form-control" disabled name="ot_numeroCq" id="ot_numeroCq">
          </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="costoInput">Costo aproximado</label>
            <input type="number" class="form-control" disabled name="ot_costoAproximado" id="ot_costoAproximado">
          </div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="ot_perito" disabled id="ot_perito">
        </div>
        <div class="form-group">
          <label for="gerenteInput">Gerente</label>
          <input type="text" class="form-control" name="ot_gerente" id="ot_gerente" value="{{$user->name}}">
        </div>
        <div class="form-group">
          <label for="observacionesTextarea">Observaciones</label>
          <textarea class="form-control" id="ot_observaciones" name="ot_observaciones" rows="2"></textarea>
        </div>
      </div>
...
var selectRuta = document.getElementById('select-ruta');
var selectZona = document.getElementById('select-zona');

selectRuta.addEventListener('change', function () {
    var idRuta = this.value;

    // Resetear el select de zonas
    selectZona.innerHTML = '<option value="">Cargando...</option>';
    selectZona.disabled = true;

    if (idRuta === '') {
        selectZona.innerHTML = '<option value="">Selecciona una ruta primero</option>';
        return;
    }

    fetch('/accidentes/zonas/' + idRuta)
